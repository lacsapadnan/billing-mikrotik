...
class Client
{
     ...
     *     persistent one.
     * @param  float|null  $timeout  The timeout for the connection.
     ...
     * @param  callable|null  $callback Optional. A function that is to be

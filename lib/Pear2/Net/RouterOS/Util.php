...
class Util implements Countable
{
    ...
    public function edit($numbers, $valueName, $newValue)
    {
        return null === $newValue
            ...
            : $this->set($numbers, [$valueName => $newValue]);
    }
     ...
     */
    public function getAll(array $args = [], Query $query = null)
    {
        ...
        foreach (['follow', 'follow-only', 'count-only'] as $arg) {
     ...
     */
    protected function doBulk($command, array $args = [])
    {

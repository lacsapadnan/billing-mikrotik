 ...
 */
class DefaultProvider implements MessageProvider, CustomMessageProvider
{
    // Properties {{{
     ...
     * @return string
     */
    protected function replaceTemplateVars($message, $vars = [])
    {

        ...
        <div class="card card-flush">
            ...
            <div class="card-body">
                ...
                <form class="form fv-plugins-bootstrap5 fv-plugins-framework flex flex-col gap-5" method="POST"
                    ...
                    <x-form.group.input name="rate_down" required :value="@$bandwidth['rate_down']" label="Rate Download" />
                    <x-form.group.select name="rate_down_unit" nolabel :options="$rateUnits" required :value="@$bandwidth['rate_down_unit']->value ?? 'Kbps'"
                        class="justify-end" />
                    <x-form.group.input name="rate_up" required :value="@$bandwidth['rate_up']" label="Rate Upload" />
                    <x-form.group.select name="rate_up_unit" nolabel :options="$rateUnits" required :value="@$bandwidth['rate_up_unit']->value ?? 'Kbps'"
                        class="justify-end" />
